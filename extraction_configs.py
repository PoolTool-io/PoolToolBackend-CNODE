...
extraction_config_91conway = [ # node 9.1 conway era mark snapshot, blocks and epoch parameters
        ...
        {"path": [4, 2, 2, 4, 4, 15], "key": "", "action": "mark_completed"},
...
action_config_91babbage_utxo_set = [ # node 9.1 babbage utxo set
        {"path": [4, 1, 1], "key": "treasury", "action": "store"},
        {"path": [4, 1, 2], "key": "reserves", "action": "store"},
        ...
        {"path": [4,2,1,2,1,'*',2,7,'*'], "key": "live_poolparams", "type": "objectinarray","action": "capture_pool_params_map", "context_key": "owner_addresss"}, # with no e1
        ...
        {"path": [4,2,2,1,'*',2,1,2], "key": "utxo_set", "action": "utxo_stake_set","context_key": "address"},
        ...
        {"path": [4,2,2,1,'*',2,2,2,1], "key": "utxo_set", "action": "utxo_stake_set","context_key": "amount3"}, # this is the amount if its on a contract
...
action_config_91conway_utxo_set = [  # node 9.1 conway utxo set
        {"path": [4, 1, 1], "key": "treasury", "action": "store"},
        {"path": [4, 1, 2], "key": "reserves", "action": "store"},
